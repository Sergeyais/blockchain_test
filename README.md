Этот файл Readme предназначен для описания кода, представленного выше. Код реализует простую блокчейн с использованием JavaScript. Ниже представлено краткое описание классов и методов в коде.
